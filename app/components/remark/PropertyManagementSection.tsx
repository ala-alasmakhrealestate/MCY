...
const locations = [
    {
        icon: <PiSecurityCameraLight className="h-10 w-10 mb-4 text-[#a27a35]"/>,
        image: <Image src={"/images/icons/school.png"} width={30} height={30} alt={"logo"}/>,
        title: "security",
        time: 1,
    },
    {
        icon: <BiSupport className="h-10 w-10 mb-4 text-[#a27a35]"/>,
        image: <Image src={"/images/icons/gym.png"} width={30} height={30} alt={"logo"}/>,
        title: "helpDesk",
        time: 1,
    },
    {
        icon: <GiVacuumCleaner className="h-10 w-10 mb-4 text-[#a27a35]"/>,
        image: <Image src={"/images/icons/health.png"} width={30} height={30} alt={"logo"}/>,
        title: "clean",
        time: 2,
    },
    {
        icon: <TbParking className="h-10 w-10 mb-4 text-[#a27a35]"/>,
