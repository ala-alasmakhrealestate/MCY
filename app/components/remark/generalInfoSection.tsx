...
export default function GeneralInfoSection() {
    ...
    return (
        <section className="pb-0 bg-white">
            <div className={"grid grid-cols-1 md:grid-cols-12 xs:gap-0 sm:gap-0 md:gap-0 lg:gap-6"}>

                <div
                    className={"col-span-6 flex items-center justify-center order-2 xs:order-2 sm:order-2 md:order-1 lg:order-1"}>
                    <div className={"bg-gray-100 py-6 px-12"}>
                        <div className={"mb-12"}>
                            <p className={"text-lg sm:text-lg md:text-xl xl:text-2xl font-avenirHeavy text-[#a27a35] mb-2"}>Large-Scale Residential
                                Development</p>
                            <p className={"text-lg sm:text-lg md:text-xl xl:text-2xl font-avenirLight"}>1,024</p>
                        </div>

                        <div className={""}>
                            <p className={"text-lg sm:text-lg md:text-xl xl:text-2xl font-avenirHeavy text-[#a27a35] mb-2"}>Properties Under Government
                                Housing</p>
                            <p className={"text-lg sm:text-lg md:text-xl xl:text-2xl font-avenirLight"}>316</p>
                        </div>
                    </div>
                </div>

                {isRtl && (
                    <div className={"order-1 col-span-6 xs:order-1 sm:order-1 md:order-1 lg:order-2"}>
                        <Swiper
                ...
                {/*<Image*/}
                {/*    src={"/images/new_pictures/interior/ARE02301-Enhanced-NR.jpg"}*/}
                {/*    alt={`Mesaimeer Info`}*/}
                {/*    width={10000}*/}
                {/*    height={10000}*/}
                {/*    className="rounded-none col-span-6 object-cover object-center w-full aspect-square order-1 xs:order-1 sm:order-1 md:order-1 lg:order-2 "*/}
                {/*/>*/}
            </div>
