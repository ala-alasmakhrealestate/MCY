    ...
    return (
        <section className="relative w-full h-[90vh] md:h-[80vh] overflow-hidden">
            ...
            <div className="block sm:hidden absolute inset-0 z-20 pointer-events-none">
                {/* MCY Logo */}
                <div className="absolute top-[5vh] left-10 bg-white backdrop-blur rounded-xl shadow-lg p-4 flex flex-col items-center gap-2 w-44 animate-float">
                    <Image src="/images/logo/mcy-logo.jpg" alt="MCY Logo" width={60} height={60} />
                    {/*<span className="text-sm font-avenirMedium uppercase text-gray-800 text-center">*/}
                    {/*    Barwa City MCY*/}
                    {/*  </span>*/}
                ...
                {/* Mesaimeer Promo Card */}
                <div className="absolute bottom-10 left-[12vw] bg-[#04264d]/30 rounded-xl shadow-lg p-5 text-white max-w-xs animate-float delay-200">
                    <h3 className="font-avenirHeavy text-lg mb-2">Mesaimeer</h3>
